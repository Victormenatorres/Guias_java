 ...
 * @author JOSE
 */
public class Guia_EjerGuiado7 extends javax.swing.JFrame {

    /**
     * Creates new form Guia_EjerGuiado7
     */
    public Guia_EjerGuiado7() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Guia_EjerGuiado7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Guia_EjerGuiado7().setVisible(true);
            }
        });
    }
