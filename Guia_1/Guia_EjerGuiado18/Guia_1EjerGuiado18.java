 ...
 * @author JOSE
 */
public class Guia_1EjerGuiado9 extends javax.swing.JFrame {

    /**
     * Creates new form Guia_1EjerGuiado9
     */
    public Guia_1EjerGuiado9() {
        initComponents();
    }
...
if (resp==JFileChooser.APPROVE_OPTION) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Guia_1EjerGuiado9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Guia_1EjerGuiado9().setVisible(true);
            }
        });
    }
