 ...
 * @author JOSE
 */
public class Guia_1EjerGuiado extends javax.swing.JFrame {

    /**
     * Creates new form Guia_1EjerGuiado
     */
    public Guia_1EjerGuiado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Guia_1EjerGuiado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Guia_1EjerGuiado().setVisible(true);
            }
        });
    }
